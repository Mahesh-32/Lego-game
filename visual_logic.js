 ...
 * Thu Apr 04 2024 19:00:25 GMT+0530 (India Standard Time)
...
function d1(a) {
  registerOnDrag(a, false, [0,1,2], function() {}, function() {
    dragMove(a, 'XY', '6RDC)4IIl@.q=:$}VS1G', '!)e+K13n@}AiDY*D*qBY');
  }, function() {}, '!)e+K13n@}AiDY*D*qBY');
}

// with b
//
function do_something(b) {
  registerOnDrag(b, false, [0,1,2], function() {}, function() {
    dragMove(b, 'XY', '0o-XBAu3Mwv3@#htfl]?', 'r;|vKi]15T2V)oR0K=[,');
  }, function() {}, 'r;|vKi]15T2V)oR0K=[,');
}
...
function do_something2(c) {
  registerOnDrag(c, false, [0,1,2], function() {}, function() {
    dragMove(c, 'XY', 'DYXGI0AbV`},Bf3r|_nA', 'u:6uz}-ywo[fWZWJ^6OU');
    if (getObjTransform(c, false, 'position', 'x') == 0 || getObjTransform(c, false, 'position', 'y') == 0) {
      setObjTransform(c, false, 'position', [0, 0, 5], false);
    }
  }, function() {}, 'u:6uz}-ywo[fWZWJ^6OU');
}
...
setHTMLElemStyle('width', '60px', 'button_1', false);
createCSSRule('#button_1', 'position:relative;top:100px;', false);
setHTMLElemStyle('height', '40px', 'button_1', false);
eventHTMLElem('click', 'button_1', false, function(event) {
  a = cloneObject('red');
  setObjTransform(a, false, 'position', [-5.78, 1.15, j], false);
  changeVis('red', true);
  j = (typeof j == 'number' ? j : 0) + 0;
  d1(a);
});
registerOnDrag('red', false, [0,1,2], function() {}, function() {
  dragMove('red', 'XY', 'c3Z?@LtUq8QO~PCE^3M|', '=zTb$fw*L{R`tOde*GyC');
}, function() {}, '=zTb$fw*L{R`tOde*GyC');

changeVis('blue', false);
addHTMLElement('button', 'button_2', 'TO', ['CONTAINER'], false);
createCSSRule('#button_2', 'position:relative;top:150px;left:-60px;', false);
setHTMLElemStyle('width', '60px', 'button_2', false);
setHTMLElemStyle('height', '40px', 'button_2', false);
setHTMLElemStyle('backgroundColor', 'blue', 'button_2', false);
eventHTMLElem('click', 'button_2', false, function(event) {
  b = cloneObject('blue');
  setObjTransform(b, false, 'position', [0, 0, k], false);
  changeVis('blue', true);
  k = (typeof k == 'number' ? k : 0) + 0;
  do_something(b);
});
registerOnDrag('blue', false, [0,1,2], function() {}, function() {
  dragMove('blue', 'XY', 'p8Lu#0%4d:rt{B[8g~%!', 'k}~(RQdzHKL~2CMj[!ai');
}, function() {}, 'k}~(RQdzHKL~2CMj[!ai');

changeVis('yellow', false);
addHTMLElement('button', 'button_3', 'TO', ['CONTAINER'], false);
createCSSRule('#button_3', 'position:relative;top:200px;left:-120px;', false);
setHTMLElemStyle('width', '60px', 'button_3', false);
setHTMLElemStyle('height', '40px', 'button_3', false);
setHTMLElemStyle('backgroundColor', 'yellow', 'button_3', false);
eventHTMLElem('click', 'button_3', false, function(event) {
  c = cloneObject('yellow');
  setObjTransform(c, false, 'position', [15, 10, i], false);
  changeVis('yellow', true);
  i = (typeof i == 'number' ? i : 0) + 0;
  do_something2(c);
});
registerOnDrag('yellow', false, [0,1,2], function() {}, function() {
  dragMove('yellow', 'XY', 'P2:,6phEA3fCFwm)AIAo', '26MiF,0IognL5Xs`Qb{1');
}, function() {}, '26MiF,0IognL5Xs`Qb{1');

objConstraintAddLimit('myConst', '<none>', 'POS_X', -1, 1, '', 0, 'LIMITDIST_ONSURFACE');

getObjTransform('yellow', false, 'position', 'x');

getObjTransform('yellow', false, 'position', 'y');
